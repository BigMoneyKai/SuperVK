...
public:
    ...
    SV_FORCE_INLINE const_iterator begin() const { return const_iterator(data_ptr()); }
    SV_FORCE_INLINE iterator end() { return iterator(data_ptr() + static_cast<addr>(m_size)); }
    SV_FORCE_INLINE const_iterator end() const { return const_iterator(data_ptr() + static_cast<addr>(m_size)); }

    SV_FORCE_INLINE reverse_iterator rbegin() { return reverse_iterator(end()); }
    SV_FORCE_INLINE const_reverse_iterator rbegin() const { return const_reverse_iterator(end()); }
    SV_FORCE_INLINE reverse_iterator rend() { return reverse_iterator(begin()); }
    SV_FORCE_INLINE const_reverse_iterator rend() const { return const_reverse_iterator(begin()); }
