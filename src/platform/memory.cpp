...
void platform_aligned_free(void *ptr) { free(ptr); }
...
void virtual_release(void *ptr, u64 size) { munmap(ptr, size); }
...
u64 page_size() { return static_cast<u64>(sysconf(_SC_PAGESIZE)); }

u64 allocation_granularity() { return page_size(); }
...
void platform_aligned_free(void *ptr) { _aligned_free(ptr); }
