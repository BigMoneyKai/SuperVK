...
constexpr VkImageUsageFlags defaultUsage = VK_IMAGE_USAGE_TRANSFER_SRC_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT;
...
public:
    ...
    SV_FORCE_INLINE const VkImage& image() const {
        return m_image;
    }
    SV_FORCE_INLINE VkImage& image() {
        return m_image;
    }
    SV_FORCE_INLINE const VkImageView& imageView() const {
        return m_imageView;
    }
    SV_FORCE_INLINE VkImageView& imageView() {
        return m_imageView;
    }
    SV_FORCE_INLINE const VkFormat& format() const {
        return m_format;
    }
    SV_FORCE_INLINE VkFormat& format() {
        return m_format;
    }
    SV_FORCE_INLINE const VkExtent3D& extent() const {
        return m_extent;
    }
    SV_FORCE_INLINE VkExtent3D& extent() {
        return m_extent;
    }

    SV_FORCE_INLINE const VkImageLayout& layout() const {
        return m_layout;
    }
    SV_FORCE_INLINE VkImageLayout& layout() {
        return m_layout;
    }
