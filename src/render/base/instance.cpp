...
void Instance::init() {
  ...
  instanceCreateInfo.enabledExtensionCount =
      static_cast<u32>(m_extensions.size());
...
void Instance::destroy() { vkDestroyInstance(m_instance, nullptr); }
...
b32 Instance::enable_validation_layer() {
  ...
  if (!layerFound) {
    WARNING(
        LogCatag::vulkan,
        "Validation layer not found in SDK, please install it or config it");
  } else {
