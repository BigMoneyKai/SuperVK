...
public:
  ...
  SV_FORCE_INLINE const VkDevice &device() const { return m_device; }
  ...
  SV_FORCE_INLINE const VkQueue &presentQueue() const { return m_presentQueue; }
  SV_FORCE_INLINE u32 graphicsQueueFamilyIndex() const {
    return m_graphicsQueueFamilyIndex;
  }
  SV_FORCE_INLINE const VkFormat &depthFormat() const { return m_depthFormat; }
  SV_FORCE_INLINE VkFormat depthFormat() { return m_depthFormat; }
